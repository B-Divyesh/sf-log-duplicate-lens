...
<a class="skip-link" href="#main">Skip to main content</a><p class="sr-only" id="route-announcer" aria-live="polite"></p><div class="network-strip"><span class="status-lamp" aria-hidden="true"></span><span>Page check</span></div>
...
<main class="legal-main" id="main"><p class="eyebrow">Route not found</p><h1 tabindex="-1">Page not found</h1><p>Check the address, return home, or open the sample analysis.</p><p class="hero-actions"><a class="button button-primary" href="/">Go home</a><a class="button button-secondary" href="/demo">Open sample analysis</a></p></main>
